...
class ana_tools:
    ...
    def GetRMS(self, data, nfemb, fp, fname):
        ...
        for ich in range(128):
            ...
            if ((ich//8)%2 == 0):
                even_check = all(item == 10901 for item in allpls)
                if not even_check:
                    print("error_e", end=", ")
                    print(data[1][global_ch])
                # else:
                #     print("right_e", end=", ")
                #     print(data[1][global_ch], end=", ")
                #     print(ich, end=", ")
                #     print(ich // 8)
            else:
                odd_check = all(item == 5482 for item in allpls)
                if not odd_check:
                    print("error_o", end=", ")
                    print(data[1][global_ch])
                # else:
